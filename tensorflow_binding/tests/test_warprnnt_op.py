...
class WarpRNNTTest(tf.test.TestCase):
    ...
    def _run_rnnt(self, acts, labels, input_lengths, label_lengths,
                  expected_costs, expected_grads, blank, fastemit_lambda, use_gpu=False):
        ...
        with tf.GradientTape() as tape:
            ...
            costs = rnnt_loss(logits, labels_t, input_lengths_t, label_lengths_t, blank, fastemit_lambda)
    ...
    def _test_multiple_batches(self, use_gpu):
        ...
        self._run_rnnt(acts, labels, input_lengths, label_lengths, expected_costs, expected_grads, 0, 0.0, use_gpu)
    ...
    def _test_multiple_batches_fastemit(self, use_gpu):
        ...
        self._run_rnnt(acts, labels, input_lengths, label_lengths, expected_costs, expected_grads, 0, 1.0, use_gpu)
